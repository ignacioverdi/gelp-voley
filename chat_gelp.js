...
wrapEl.innerHTML=[
  ...
  '<div class="vb-hdr">',
  '<svg class="vb-hdr-ball" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><circle cx="15" cy="15" r="14" fill="#1e3a8a"/><circle cx="15" cy="15" r="13" fill="#dbeafe"/><path d="M2,8 Q5,3 10,2 Q12,6 8,11 Q5,9 2,8Z" fill="#1e3a8a" opacity=".9"/><path d="M16,2 Q21,4 24,8 Q20,11 16,8 Q16,5 16,2Z" fill="#1e3a8a" opacity=".9"/><path d="M5,20 Q8,24 14,24 Q15,20 12,17 Q9,18 5,20Z" fill="#1e3a8a" opacity=".9"/><g fill="none" stroke="#9094b7" stroke-width="1.5" stroke-linecap="round"><path d="M10,2 Q14,7 15,6 Q18,4 16,2"/><path d="M16,2 Q15,8 18,11 Q21,10 24,8"/></g></svg>',
